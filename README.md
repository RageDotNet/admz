...
See [Why We Built This](docs/why-we-built-this.md) for the problem statement. Normative v2 behavior is in the [PRD index](docs/index-v2.md). Licensed [MIT](LICENSE). Contributions: [CONTRIBUTING.md](CONTRIBUTING.md). Security reports: [SECURITY.md](SECURITY.md).
